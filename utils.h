...
#define CACHE_EVICTION_FORMAT "[MEM]: Cache eviction for address: 0x%llx\n"
#define CACHE_HIT_FORMAT "[MEM]: Cache hit for address: 0x%llx\n"
#define CACHE_MISS_FORMAT "[MEM]: Cache miss for address: 0x%llx\n"
